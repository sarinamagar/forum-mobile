...
class LoadUserForumsUsecase extends BaseUseCase<List<Forum>, String> {
  final ForumRepository forumRepository;

  LoadUserForumsUsecase({required this.forumRepository});

  @override
  Future<Either<Failure, List<Forum>>> call(String dto) {
    return forumRepository.loadUserForums(dto);
  }
}
